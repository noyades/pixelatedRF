  ...
  def __init__(self,
    ...
    def create_open_ael(self):
      ...
      with open(aelPath, 'w') as f:
        ...
        '''
        if self.ports == 2:
          f.write('decl pin = db_create_pin(macroContext, ' + str(self.portPosition[0]) + ',' + str(self.portPosition[1]) \
          ...
          f.write('decl pin = db_create_pin(macroContext, ' + str(self.portPosition[2]) + ',' + str(self.portPosition[3]) \
          ...
          f.write('decl pin = db_create_pin(macroContext, ' + str(self.portPosition[2]) + ',' + str(self.portPosition[3]) \
                  + ',' + str(90) + ', db_layerid(39), 2, "P2", 2);\n')
          f.write('decl pin = db_create_pin(macroContext, ' + str(self.portPosition[4]) + ',' + str(self.portPosition[5]) \
          ...
          f.write('decl pin = db_create_pin(macroContext, ' + str(self.portPosition[4]) + ',' + str(self.portPosition[5]) \
                  + ',' + str(0) + ', db_layerid(39), 3, "P3", 2);\n')
          f.write('decl pin = db_create_pin(macroContext, ' + str(self.portPosition[6]) + ',' + str(self.portPosition[7]) \
