      ...
      if self.corner == 'noverlap': 
        ...
        for x in range(0,cols):
          for y in range(0,rows):
            ...
            #   #UNIT.add(rect)
            # if caseMap[y,x] == 2:
            #   points = self.pixel_shape(2)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 3:
            #   points = self.pixel_shape(3)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 4:
            #   points = self.pixel_shape(4)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 5:
            #   points = self.pixel_shape(5)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 6:
            #   points = self.pixel_shape(6)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 7:
            #   points = self.pixel_shape(7)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 8:
            #   points = self.pixel_shape(8)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 9:
            #   points = self.pixel_shape(9)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 10:
            #   points = self.pixel_shape(10)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 11:
            #   points = self.pixel_shape(11)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 12:
            #   points = self.pixel_shape(12)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 13:
            #   points = self.pixel_shape(13)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 14:
            #   points = self.pixel_shape(14)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 15:
            #   points = self.pixel_shape(15)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
            # if caseMap[y,x] == 16:
            #   points = self.pixel_shape(16)
            #   poly = gdspy.Polygon(points, **l_top).translate(x*self.pixelSize,y*self.pixelSize)
            #   UNIT.add(poly)
