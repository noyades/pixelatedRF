...
y = 756
for x in range(248184,1000000): # Run 100 iterations of file generation and simulation.
  data_file = pathName + 'data/' + "randomGDSSteppedImpFilter_Type=" + filtType + "_order=" + str(filtOrder) + "_pixelSize=" + \
              str(pixelSize) + "_dc12=" + str(y)

  portPosition, xBoard, yBoard, csv_file, gds_file, cell = usrc.randomGDS_dim(sub1, filtOrder,ports,sides,xBoard, \
                                                     yBoard, pixelSize, z0, EL, x, connectMap, simulator, view, \
                                                     write, data_file)
